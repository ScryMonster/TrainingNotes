...
interface IEnterUserInteractor {
    ...
    fun signIn(email:String?, password: String?, success:(Account)->Unit, error:(java.lang.Exception)->Unit)
    fun register(email:String?, password: String?, success:(Account)->Unit, error:(java.lang.Exception)->Unit)
}
...
class DoubleProgressView @JvmOverloads constructor(context: Context,
    ...
    private fun init(attrs: AttributeSet?, defStyleRes: Int?) {
        ...
        mOuterCircleColor = array.getColor(R.styleable.DoubleProgressView_outerColor, res.getColor(R.color.windows_blue))
        mInnerSquareColor = array.getColor(R.styleable.DoubleProgressView_innerColor, res.getColor(R.color.soft_green))
